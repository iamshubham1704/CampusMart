      ...
      {stats && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 0.5rem 0', color: '#007bff' }}>Total Users</h3>
            <p style={{ fontSize: '2rem', fontWeight: 'bold', margin: 0, color: '#333' }}>
              {stats.users.totalUsers}
            </p>
            <small style={{ color: '#666' }}>
              {stats.users.totalBuyers} Buyers, {stats.users.totalSellers} Sellers
            </small>
          </div>
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 0.5rem 0', color: '#28a745' }}>Active Users</h3>
            <p style={{ fontSize: '2rem', fontWeight: 'bold', margin: 0, color: '#333' }}>
              {stats.overview.activeUsers}
            </p>
            <small style={{ color: '#666' }}>
              {stats.users.activeBuyers} Buyers, {stats.users.activeSellers} Sellers
            </small>
          </div>
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 0.5rem 0', color: '#dc3545' }}>Inactive Users</h3>
            <p style={{ fontSize: '2rem', fontWeight: 'bold', margin: 0, color: '#333' }}>
              {stats.overview.inactiveUsers}
            </p>
            <small style={{ color: '#666' }}>
              {stats.users.inactiveBuyers} Buyers, {stats.users.inactiveSellers} Sellers
            </small>
          </div>
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 0.5rem 0', color: '#ffc107' }}>New This Week</h3>
            <p style={{ fontSize: '2rem', fontWeight: 'bold', margin: 0, color: '#333' }}>
              {stats.users.newUsersThisWeek}
            </p>
            <small style={{ color: '#666' }}>
              {stats.users.newBuyersThisWeek} Buyers, {stats.users.newSellersThisWeek} Sellers
            </small>
          </div>
        </div>
      )}
